...
public class ApiServiceTest {
    ...
    public void testGetAccount() {
        ...
        assertEquals(ACCOUNT, apiService.getAccount(ACCOUNT_ID));
    }
    ...
    public void testGetNonExistingAccount() {
        ...
        assertThrows(RuntimeException.class, () -> apiService.getAccount(ACCOUNT_ID));
    }
    ...
    public void testGetAccountsForPerson() {
        ...
        assertEquals(ACCOUNTS, apiService.getAccounts(PERSON_ID));
    }
    ...
    public void testGetAccountsForNonExistingPerson() {
        ...
        Mockito.when(accountService.getAccounts(PERSON)).thenReturn(ACCOUNTS);
        assertThrows(RuntimeException.class, () -> apiService.getAccounts(PERSON_ID));
    }
    ...
    public void testCreateAccountForPerson() {
        ...
        assertTrue(apiService.createAccount(ACCOUNT_ID, PERSON_ID));
    }
    ...
    public void testCreateAccountForPersonButAccountCreationFails() {
        ...
        assertFalse(apiService.createAccount(ACCOUNT_ID, PERSON_ID));
        Mockito.verify(personService.getPerson(Mockito.anyString()));
        Mockito.verify(accountService.createAccount(Mockito.anyString(), any()));
    }
    ...
    public void testCreateAccountForNullPerson() {
        ...
        Mockito.when(accountService.createAccount(Mockito.anyString(), any())).thenReturn(false);
        assertThrows(RuntimeException.class, () -> apiService.createAccount(ACCOUNT_ID, null));
    }
    ...
    public void testCreateNullAccountForPerson() {
        ...
        assertThrows(RuntimeException.class, () -> apiService.createAccount(null, PERSON_ID));
    }
    ...
    public void testCreatingSeveralAccountsForPerson() {
        ...
        assertEquals(2, apiService.getAccounts(PERSON_ID).size());
    }
}
